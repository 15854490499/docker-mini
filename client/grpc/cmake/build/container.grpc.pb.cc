...
static const char* ContainerService_method_names[] = {
  "/container.ContainerService/CreateConatiner",
...
ContainerService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_CreateConatiner_(ContainerService_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  ...
  , rpcmethod_RemoveContainer_(ContainerService_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}

::grpc::Status ContainerService::Stub::CreateConatiner(::grpc::ClientContext* context, const ::container::CreateRequest& request, ::container::CreateReply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::container::CreateRequest, ::container::CreateReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_CreateConatiner_, context, request, response);
}

void ContainerService::Stub::async::CreateConatiner(::grpc::ClientContext* context, const ::container::CreateRequest* request, ::container::CreateReply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::container::CreateRequest, ::container::CreateReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_CreateConatiner_, context, request, response, std::move(f));
}

void ContainerService::Stub::async::CreateConatiner(::grpc::ClientContext* context, const ::container::CreateRequest* request, ::container::CreateReply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_CreateConatiner_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::container::CreateReply>* ContainerService::Stub::PrepareAsyncCreateConatinerRaw(::grpc::ClientContext* context, const ::container::CreateRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::container::CreateReply, ::container::CreateRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_CreateConatiner_, context, request);
}

::grpc::ClientAsyncResponseReader< ::container::CreateReply>* ContainerService::Stub::AsyncCreateConatinerRaw(::grpc::ClientContext* context, const ::container::CreateRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncCreateConatinerRaw(context, request, cq);
  result->StartCall();
  return result;
}
      ...
      new ::grpc::internal::RpcMethodHandler< ContainerService::Service, ::container::CreateRequest, ::container::CreateReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](ContainerService::Service* service,
             ...
             ::container::CreateReply* resp) {
               return service->CreateConatiner(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status ContainerService::Service::CreateConatiner(::grpc::ServerContext* context, const ::container::CreateRequest* request, ::container::CreateReply* response) {
  (void) context;
  (void) request;
  (void) response;
