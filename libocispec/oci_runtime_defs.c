...
define_cleaner_function (oci_runtime_defs_hook *, free_oci_runtime_defs_hook)
oci_runtime_defs_hook *
make_oci_runtime_defs_hook (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_hook) oci_runtime_defs_hook *ret = NULL;
    *err = NULL;
...
void
free_oci_runtime_defs_hook (oci_runtime_defs_hook *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->path);
...
yajl_gen_status
gen_oci_runtime_defs_hook (yajl_gen g, const oci_runtime_defs_hook *ptr, const struct parser_context *ctx, parser_error *err)
{
...
define_cleaner_function (oci_runtime_defs_id_mapping *, free_oci_runtime_defs_id_mapping)
oci_runtime_defs_id_mapping *
make_oci_runtime_defs_id_mapping (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_id_mapping) oci_runtime_defs_id_mapping *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_id_mapping (oci_runtime_defs_id_mapping *ptr)
{
    if (ptr == NULL)
        return;
    yajl_tree_free (ptr->_residual);
...
yajl_gen_status
gen_oci_runtime_defs_id_mapping (yajl_gen g, const oci_runtime_defs_id_mapping *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_defs_mount *, free_oci_runtime_defs_mount)
oci_runtime_defs_mount *
make_oci_runtime_defs_mount (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_mount) oci_runtime_defs_mount *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_mount (oci_runtime_defs_mount *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->source);
...
yajl_gen_status
gen_oci_runtime_defs_mount (yajl_gen g, const oci_runtime_defs_mount *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
