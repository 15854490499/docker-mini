...
define_cleaner_function (oci_runtime_defs_linux_personality *, free_oci_runtime_defs_linux_personality)
oci_runtime_defs_linux_personality *
make_oci_runtime_defs_linux_personality (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_personality) oci_runtime_defs_linux_personality *ret = NULL;
    *err = NULL;
...
void
free_oci_runtime_defs_linux_personality (oci_runtime_defs_linux_personality *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->domain);
...
yajl_gen_status
gen_oci_runtime_defs_linux_personality (yajl_gen g, const oci_runtime_defs_linux_personality *ptr, const struct parser_context *ctx, parser_error *err)
{
...
define_cleaner_function (oci_runtime_defs_linux_syscall_arg *, free_oci_runtime_defs_linux_syscall_arg)
oci_runtime_defs_linux_syscall_arg *
make_oci_runtime_defs_linux_syscall_arg (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_syscall_arg) oci_runtime_defs_linux_syscall_arg *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_linux_syscall_arg (oci_runtime_defs_linux_syscall_arg *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->op);
...
yajl_gen_status
gen_oci_runtime_defs_linux_syscall_arg (yajl_gen g, const oci_runtime_defs_linux_syscall_arg *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_defs_linux_syscall *, free_oci_runtime_defs_linux_syscall)
oci_runtime_defs_linux_syscall *
make_oci_runtime_defs_linux_syscall (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_syscall) oci_runtime_defs_linux_syscall *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->args[i] = make_oci_runtime_defs_linux_syscall_arg (val, ctx, err);
                if (ret->args[i] == NULL)
                  return NULL;
              }
          }
...
void
free_oci_runtime_defs_linux_syscall (oci_runtime_defs_linux_syscall *ptr)
{
    if (ptr == NULL)
        return;
    if (ptr->names != NULL)
    ...
    if (ptr->args != NULL)      {
        ...
        for (i = 0; i < ptr->args_len; i++)
          ...
          if (ptr->args[i] != NULL)
            {
              free_oci_runtime_defs_linux_syscall_arg (ptr->args[i]);
              ptr->args[i] = NULL;
            }
          }
        free (ptr->args);
...
yajl_gen_status
gen_oci_runtime_defs_linux_syscall (yajl_gen g, const oci_runtime_defs_linux_syscall *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->args != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_linux_syscall_arg (g, ptr->args[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
...
define_cleaner_function (oci_runtime_defs_linux_device *, free_oci_runtime_defs_linux_device)
oci_runtime_defs_linux_device *
make_oci_runtime_defs_linux_device (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_device) oci_runtime_defs_linux_device *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_linux_device (oci_runtime_defs_linux_device *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->type);
...
yajl_gen_status
gen_oci_runtime_defs_linux_device (yajl_gen g, const oci_runtime_defs_linux_device *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_defs_linux_block_io_device *, free_oci_runtime_defs_linux_block_io_device)
oci_runtime_defs_linux_block_io_device *
make_oci_runtime_defs_linux_block_io_device (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_block_io_device) oci_runtime_defs_linux_block_io_device *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_linux_block_io_device (oci_runtime_defs_linux_block_io_device *ptr)
{
    if (ptr == NULL)
        return;
    yajl_tree_free (ptr->_residual);
...
yajl_gen_status
gen_oci_runtime_defs_linux_block_io_device (yajl_gen g, const oci_runtime_defs_linux_block_io_device *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_defs_linux_block_io_device_weight *, free_oci_runtime_defs_linux_block_io_device_weight)
oci_runtime_defs_linux_block_io_device_weight *
make_oci_runtime_defs_linux_block_io_device_weight (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_block_io_device_weight) oci_runtime_defs_linux_block_io_device_weight *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_linux_block_io_device_weight (oci_runtime_defs_linux_block_io_device_weight *ptr)
{
    if (ptr == NULL)
        return;
    yajl_tree_free (ptr->_residual);
...
yajl_gen_status
gen_oci_runtime_defs_linux_block_io_device_weight (yajl_gen g, const oci_runtime_defs_linux_block_io_device_weight *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_defs_linux_block_io_device_throttle *, free_oci_runtime_defs_linux_block_io_device_throttle)
oci_runtime_defs_linux_block_io_device_throttle *
make_oci_runtime_defs_linux_block_io_device_throttle (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_block_io_device_throttle) oci_runtime_defs_linux_block_io_device_throttle *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_linux_block_io_device_throttle (oci_runtime_defs_linux_block_io_device_throttle *ptr)
{
    if (ptr == NULL)
        return;
    yajl_tree_free (ptr->_residual);
...
yajl_gen_status
gen_oci_runtime_defs_linux_block_io_device_throttle (yajl_gen g, const oci_runtime_defs_linux_block_io_device_throttle *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_defs_linux_device_cgroup *, free_oci_runtime_defs_linux_device_cgroup)
oci_runtime_defs_linux_device_cgroup *
make_oci_runtime_defs_linux_device_cgroup (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_device_cgroup) oci_runtime_defs_linux_device_cgroup *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_linux_device_cgroup (oci_runtime_defs_linux_device_cgroup *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->type);
...
yajl_gen_status
gen_oci_runtime_defs_linux_device_cgroup (yajl_gen g, const oci_runtime_defs_linux_device_cgroup *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_defs_linux_network_interface_priority *, free_oci_runtime_defs_linux_network_interface_priority)
oci_runtime_defs_linux_network_interface_priority *
make_oci_runtime_defs_linux_network_interface_priority (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_network_interface_priority) oci_runtime_defs_linux_network_interface_priority *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_linux_network_interface_priority (oci_runtime_defs_linux_network_interface_priority *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->name);
...
yajl_gen_status
gen_oci_runtime_defs_linux_network_interface_priority (yajl_gen g, const oci_runtime_defs_linux_network_interface_priority *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_defs_linux_rdma *, free_oci_runtime_defs_linux_rdma)
oci_runtime_defs_linux_rdma *
make_oci_runtime_defs_linux_rdma (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_rdma) oci_runtime_defs_linux_rdma *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_linux_rdma (oci_runtime_defs_linux_rdma *ptr)
{
    if (ptr == NULL)
        return;
    yajl_tree_free (ptr->_residual);
...
yajl_gen_status
gen_oci_runtime_defs_linux_rdma (yajl_gen g, const oci_runtime_defs_linux_rdma *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_defs_linux_namespace_reference *, free_oci_runtime_defs_linux_namespace_reference)
oci_runtime_defs_linux_namespace_reference *
make_oci_runtime_defs_linux_namespace_reference (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_namespace_reference) oci_runtime_defs_linux_namespace_reference *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_linux_namespace_reference (oci_runtime_defs_linux_namespace_reference *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->type);
...
yajl_gen_status
gen_oci_runtime_defs_linux_namespace_reference (yajl_gen g, const oci_runtime_defs_linux_namespace_reference *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_defs_linux_time_offsets *, free_oci_runtime_defs_linux_time_offsets)
oci_runtime_defs_linux_time_offsets *
make_oci_runtime_defs_linux_time_offsets (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_defs_linux_time_offsets) oci_runtime_defs_linux_time_offsets *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_defs_linux_time_offsets (oci_runtime_defs_linux_time_offsets *ptr)
{
    if (ptr == NULL)
        return;
    yajl_tree_free (ptr->_residual);
...
yajl_gen_status
gen_oci_runtime_defs_linux_time_offsets (yajl_gen g, const oci_runtime_defs_linux_time_offsets *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
