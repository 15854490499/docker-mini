...
#include "image_spec_schema_manifest_schema2.h"

#define YAJL_GET_ARRAY_NO_CHECK(v) (&(v)->u.array)
#define YAJL_GET_OBJECT_NO_CHECK(v) (&(v)->u.object)
define_cleaner_function (image_spec_schema_manifest_schema2_config *, free_image_spec_schema_manifest_schema2_config)
image_spec_schema_manifest_schema2_config *
make_image_spec_schema_manifest_schema2_config (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_image_spec_schema_manifest_schema2_config) image_spec_schema_manifest_schema2_config *ret = NULL;
    *err = NULL;
...
void
free_image_spec_schema_manifest_schema2_config (image_spec_schema_manifest_schema2_config *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->media_type);
...
yajl_gen_status
gen_image_spec_schema_manifest_schema2_config (yajl_gen g, const image_spec_schema_manifest_schema2_config *ptr, const struct parser_context *ctx, parser_error *err)
{
...
define_cleaner_function (image_spec_schema_manifest_schema2_layers_element *, free_image_spec_schema_manifest_schema2_layers_element)
image_spec_schema_manifest_schema2_layers_element *
make_image_spec_schema_manifest_schema2_layers_element (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_image_spec_schema_manifest_schema2_layers_element) image_spec_schema_manifest_schema2_layers_element *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_image_spec_schema_manifest_schema2_layers_element (image_spec_schema_manifest_schema2_layers_element *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->media_type);
...
yajl_gen_status
gen_image_spec_schema_manifest_schema2_layers_element (yajl_gen g, const image_spec_schema_manifest_schema2_layers_element *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (image_spec_schema_manifest_schema2 *, free_image_spec_schema_manifest_schema2)
image_spec_schema_manifest_schema2 *
make_image_spec_schema_manifest_schema2 (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_image_spec_schema_manifest_schema2) image_spec_schema_manifest_schema2 *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
    ...
    while (0);
    ret->config = make_image_spec_schema_manifest_schema2_config (get_val (tree, "config", yajl_t_object), ctx, err);
            ...
            for (i = 0; i < len; i++)
              {
                ...
                ret->layers[i] = make_image_spec_schema_manifest_schema2_layers_element (val, ctx, err);
...
void
free_image_spec_schema_manifest_schema2 (image_spec_schema_manifest_schema2 *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->media_type);
    ...
    if (ptr->config != NULL)
      {
        free_image_spec_schema_manifest_schema2_config (ptr->config);
        ptr->config = NULL;
      }
    if (ptr->layers != NULL)      {
        size_t i;
        for (i = 0; i < ptr->layers_len; i++)
          ...
          if (ptr->layers[i] != NULL)
            {
              free_image_spec_schema_manifest_schema2_layers_element (ptr->layers[i]);
              ptr->layers[i] = NULL;
            }
          }
        free (ptr->layers);
...
yajl_gen_status
gen_image_spec_schema_manifest_schema2 (yajl_gen g, const image_spec_schema_manifest_schema2 *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->config != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_image_spec_schema_manifest_schema2_config (g, ptr != NULL ? ptr->config : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->layers != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_image_spec_schema_manifest_schema2_layers_element (g, ptr->layers[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
...
image_spec_schema_manifest_schema2 *
image_spec_schema_manifest_schema2_parse_file (const char *filename, const struct parser_context *ctx, parser_error *err)
{
image_spec_schema_manifest_schema2 *ptr = NULL;size_t filesize;
    ...
    if (content == NULL)
      {
        if (asprintf (err, "cannot read the file: %s", filename) < 0)
            *err = strdup ("error allocating memory");
        return NULL;
      }ptr = image_spec_schema_manifest_schema2_parse_data (content, ctx, err);return ptr;
}
image_spec_schema_manifest_schema2 * 
image_spec_schema_manifest_schema2_parse_file_stream (FILE *stream, const struct parser_context *ctx, parser_error *err)
{image_spec_schema_manifest_schema2 *ptr = NULL;
size_t filesize;
    __auto_free char *content = NULL;
...
define_cleaner_function (yajl_val, yajl_tree_free)
 ...
 { 
  image_spec_schema_manifest_schema2 *ptr = NULL;__auto_cleanup(yajl_tree_free) yajl_val tree = NULL;
    char errbuf[1024];
...
ptr = make_image_spec_schema_manifest_schema2 (tree, ctx, err);return ptr; 
}
...
define_cleaner_function (yajl_gen, cleanup_yajl_gen)
 ...
 char * 
image_spec_schema_manifest_schema2_generate_json (const image_spec_schema_manifest_schema2 *ptr, const struct parser_context *ctx, parser_error *err){
...
if (yajl_gen_status_ok != gen_image_spec_schema_manifest_schema2 (g, ptr, ctx, err))  {
        if (*err == NULL)
