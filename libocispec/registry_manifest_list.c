...
define_cleaner_function (registry_manifest_list_manifests_platform *, free_registry_manifest_list_manifests_platform)
registry_manifest_list_manifests_platform *
make_registry_manifest_list_manifests_platform (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_registry_manifest_list_manifests_platform) registry_manifest_list_manifests_platform *ret = NULL;
    *err = NULL;
...
void
free_registry_manifest_list_manifests_platform (registry_manifest_list_manifests_platform *ptr)
{
    if (ptr == NULL)
        return;
...
yajl_gen_status
gen_registry_manifest_list_manifests_platform (yajl_gen g, const registry_manifest_list_manifests_platform *ptr, const struct parser_context *ctx, parser_error *err)
{
...
define_cleaner_function (registry_manifest_list_manifests_element *, free_registry_manifest_list_manifests_element)
registry_manifest_list_manifests_element *
make_registry_manifest_list_manifests_element (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_registry_manifest_list_manifests_element) registry_manifest_list_manifests_element *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
    ...
    while (0);
    ret->platform = make_registry_manifest_list_manifests_platform (get_val (tree, "platform", yajl_t_object), ctx, err);
...
void
free_registry_manifest_list_manifests_element (registry_manifest_list_manifests_element *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->media_type);
    ...
    if (ptr->platform != NULL)
      {
        free_registry_manifest_list_manifests_platform (ptr->platform);
        ptr->platform = NULL;
      }
    free (ptr);
}
...
yajl_gen_status
gen_registry_manifest_list_manifests_element (yajl_gen g, const registry_manifest_list_manifests_element *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->platform != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_registry_manifest_list_manifests_platform (g, ptr != NULL ? ptr->platform : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    stat = yajl_gen_map_close ((yajl_gen) g);
...
define_cleaner_function (registry_manifest_list *, free_registry_manifest_list)
registry_manifest_list *
make_registry_manifest_list (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_registry_manifest_list) registry_manifest_list *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->manifests[i] = make_registry_manifest_list_manifests_element (val, ctx, err);
...
void
free_registry_manifest_list (registry_manifest_list *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->media_type);
    ...
    if (ptr->manifests != NULL)      {
        ...
        for (i = 0; i < ptr->manifests_len; i++)
          ...
          if (ptr->manifests[i] != NULL)
            {
              free_registry_manifest_list_manifests_element (ptr->manifests[i]);
...
yajl_gen_status
gen_registry_manifest_list (yajl_gen g, const registry_manifest_list *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->manifests != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_registry_manifest_list_manifests_element (g, ptr->manifests[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
...
registry_manifest_list *
registry_manifest_list_parse_file (const char *filename, const struct parser_context *ctx, parser_error *err)
{
registry_manifest_list *ptr = NULL;size_t filesize;
    ...
    if (content == NULL)
      {
        if (asprintf (err, "cannot read the file: %s", filename) < 0)
            *err = strdup ("error allocating memory");
        return NULL;
      }ptr = registry_manifest_list_parse_data (content, ctx, err);return ptr;
}
registry_manifest_list * 
registry_manifest_list_parse_file_stream (FILE *stream, const struct parser_context *ctx, parser_error *err)
{registry_manifest_list *ptr = NULL;
size_t filesize;
    __auto_free char *content = NULL;
...
define_cleaner_function (yajl_val, yajl_tree_free)
 ...
 { 
  registry_manifest_list *ptr = NULL;__auto_cleanup(yajl_tree_free) yajl_val tree = NULL;
    char errbuf[1024];
...
ptr = make_registry_manifest_list (tree, ctx, err);return ptr; 
}
...
define_cleaner_function (yajl_gen, cleanup_yajl_gen)
 ...
 char * 
registry_manifest_list_generate_json (const registry_manifest_list *ptr, const struct parser_context *ctx, parser_error *err){
...
if (yajl_gen_status_ok != gen_registry_manifest_list (g, ptr, ctx, err))  {
        if (*err == NULL)
