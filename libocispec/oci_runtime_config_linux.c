...
define_cleaner_function (oci_runtime_config_linux_resources_pids *, free_oci_runtime_config_linux_resources_pids)
oci_runtime_config_linux_resources_pids *
make_oci_runtime_config_linux_resources_pids (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux_resources_pids) oci_runtime_config_linux_resources_pids *ret = NULL;
    *err = NULL;
...
void
free_oci_runtime_config_linux_resources_pids (oci_runtime_config_linux_resources_pids *ptr)
{
    if (ptr == NULL)
        return;
...
yajl_gen_status
gen_oci_runtime_config_linux_resources_pids (yajl_gen g, const oci_runtime_config_linux_resources_pids *ptr, const struct parser_context *ctx, parser_error *err)
{
...
define_cleaner_function (oci_runtime_config_linux_resources_block_io *, free_oci_runtime_config_linux_resources_block_io)
oci_runtime_config_linux_resources_block_io *
make_oci_runtime_config_linux_resources_block_io (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux_resources_block_io) oci_runtime_config_linux_resources_block_io *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
            ...
            for (i = 0; i < len; i++)
              {
                ...
                ret->throttle_read_bps_device[i] = make_oci_runtime_defs_linux_block_io_device_throttle (val, ctx, err);
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->throttle_write_bps_device[i] = make_oci_runtime_defs_linux_block_io_device_throttle (val, ctx, err);
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->throttle_read_iops_device[i] = make_oci_runtime_defs_linux_block_io_device_throttle (val, ctx, err);
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->throttle_write_iops_device[i] = make_oci_runtime_defs_linux_block_io_device_throttle (val, ctx, err);
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->weight_device[i] = make_oci_runtime_defs_linux_block_io_device_weight (val, ctx, err);
...
void
free_oci_runtime_config_linux_resources_block_io (oci_runtime_config_linux_resources_block_io *ptr)
{
    if (ptr == NULL)
        return;
    if (ptr->throttle_read_bps_device != NULL)      {
        ...
        for (i = 0; i < ptr->throttle_read_bps_device_len; i++)
          ...
          if (ptr->throttle_read_bps_device[i] != NULL)
            {
              free_oci_runtime_defs_linux_block_io_device_throttle (ptr->throttle_read_bps_device[i]);
    ...
    if (ptr->throttle_write_bps_device != NULL)      {
        ...
        for (i = 0; i < ptr->throttle_write_bps_device_len; i++)
          ...
          if (ptr->throttle_write_bps_device[i] != NULL)
            {
              free_oci_runtime_defs_linux_block_io_device_throttle (ptr->throttle_write_bps_device[i]);
    ...
    if (ptr->throttle_read_iops_device != NULL)      {
        ...
        for (i = 0; i < ptr->throttle_read_iops_device_len; i++)
          ...
          if (ptr->throttle_read_iops_device[i] != NULL)
            {
              free_oci_runtime_defs_linux_block_io_device_throttle (ptr->throttle_read_iops_device[i]);
    ...
    if (ptr->throttle_write_iops_device != NULL)      {
        ...
        for (i = 0; i < ptr->throttle_write_iops_device_len; i++)
          ...
          if (ptr->throttle_write_iops_device[i] != NULL)
            {
              free_oci_runtime_defs_linux_block_io_device_throttle (ptr->throttle_write_iops_device[i]);
    ...
    if (ptr->weight_device != NULL)      {
        ...
        for (i = 0; i < ptr->weight_device_len; i++)
          ...
          if (ptr->weight_device[i] != NULL)
            {
              free_oci_runtime_defs_linux_block_io_device_weight (ptr->weight_device[i]);
...
yajl_gen_status
gen_oci_runtime_config_linux_resources_block_io (yajl_gen g, const oci_runtime_config_linux_resources_block_io *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->throttle_read_bps_device != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_linux_block_io_device_throttle (g, ptr->throttle_read_bps_device[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->throttle_write_bps_device != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_linux_block_io_device_throttle (g, ptr->throttle_write_bps_device[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->throttle_read_iops_device != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_linux_block_io_device_throttle (g, ptr->throttle_read_iops_device[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->throttle_write_iops_device != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_linux_block_io_device_throttle (g, ptr->throttle_write_iops_device[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->weight_device != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_linux_block_io_device_weight (g, ptr->weight_device[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
...
define_cleaner_function (oci_runtime_config_linux_resources_cpu *, free_oci_runtime_config_linux_resources_cpu)
oci_runtime_config_linux_resources_cpu *
make_oci_runtime_config_linux_resources_cpu (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux_resources_cpu) oci_runtime_config_linux_resources_cpu *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_config_linux_resources_cpu (oci_runtime_config_linux_resources_cpu *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->cpus);
...
yajl_gen_status
gen_oci_runtime_config_linux_resources_cpu (yajl_gen g, const oci_runtime_config_linux_resources_cpu *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_config_linux_resources_hugepage_limits_element *, free_oci_runtime_config_linux_resources_hugepage_limits_element)
oci_runtime_config_linux_resources_hugepage_limits_element *
make_oci_runtime_config_linux_resources_hugepage_limits_element (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux_resources_hugepage_limits_element) oci_runtime_config_linux_resources_hugepage_limits_element *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_config_linux_resources_hugepage_limits_element (oci_runtime_config_linux_resources_hugepage_limits_element *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->page_size);
...
yajl_gen_status
gen_oci_runtime_config_linux_resources_hugepage_limits_element (yajl_gen g, const oci_runtime_config_linux_resources_hugepage_limits_element *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_config_linux_resources_memory *, free_oci_runtime_config_linux_resources_memory)
oci_runtime_config_linux_resources_memory *
make_oci_runtime_config_linux_resources_memory (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux_resources_memory) oci_runtime_config_linux_resources_memory *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_config_linux_resources_memory (oci_runtime_config_linux_resources_memory *ptr)
{
    if (ptr == NULL)
        return;
    yajl_tree_free (ptr->_residual);
...
yajl_gen_status
gen_oci_runtime_config_linux_resources_memory (yajl_gen g, const oci_runtime_config_linux_resources_memory *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_config_linux_resources_network *, free_oci_runtime_config_linux_resources_network)
oci_runtime_config_linux_resources_network *
make_oci_runtime_config_linux_resources_network (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux_resources_network) oci_runtime_config_linux_resources_network *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->priorities[i] = make_oci_runtime_defs_linux_network_interface_priority (val, ctx, err);
...
void
free_oci_runtime_config_linux_resources_network (oci_runtime_config_linux_resources_network *ptr)
{
    if (ptr == NULL)
        return;
    if (ptr->priorities != NULL)      {
        ...
        for (i = 0; i < ptr->priorities_len; i++)
          ...
          if (ptr->priorities[i] != NULL)
            {
              free_oci_runtime_defs_linux_network_interface_priority (ptr->priorities[i]);
...
yajl_gen_status
gen_oci_runtime_config_linux_resources_network (yajl_gen g, const oci_runtime_config_linux_resources_network *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->priorities != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_linux_network_interface_priority (g, ptr->priorities[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
...
define_cleaner_function (oci_runtime_config_linux_resources_rdma *, free_oci_runtime_config_linux_resources_rdma)
oci_runtime_config_linux_resources_rdma *
make_oci_runtime_config_linux_resources_rdma (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux_resources_rdma) oci_runtime_config_linux_resources_rdma *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_config_linux_resources_rdma (oci_runtime_config_linux_resources_rdma *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr);
...
yajl_gen_status
gen_oci_runtime_config_linux_resources_rdma (yajl_gen g, const oci_runtime_config_linux_resources_rdma *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_config_linux_resources *, free_oci_runtime_config_linux_resources)
oci_runtime_config_linux_resources *
make_oci_runtime_config_linux_resources (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux_resources) oci_runtime_config_linux_resources *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->devices[i] = make_oci_runtime_defs_linux_device_cgroup (val, ctx, err);
    ...
    while (0);
    ret->pids = make_oci_runtime_config_linux_resources_pids (get_val (tree, "pids", yajl_t_object), ctx, err);
    if (ret->pids == NULL && *err != 0)
      return NULL;
    ret->block_io = make_oci_runtime_config_linux_resources_block_io (get_val (tree, "blockIO", yajl_t_object), ctx, err);
    if (ret->block_io == NULL && *err != 0)
      return NULL;
    ret->cpu = make_oci_runtime_config_linux_resources_cpu (get_val (tree, "cpu", yajl_t_object), ctx, err);
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->hugepage_limits[i] = make_oci_runtime_config_linux_resources_hugepage_limits_element (val, ctx, err);
    ...
    while (0);
    ret->memory = make_oci_runtime_config_linux_resources_memory (get_val (tree, "memory", yajl_t_object), ctx, err);
    if (ret->memory == NULL && *err != 0)
      return NULL;
    ret->network = make_oci_runtime_config_linux_resources_network (get_val (tree, "network", yajl_t_object), ctx, err);
    if (ret->network == NULL && *err != 0)
      return NULL;
    ret->rdma = make_oci_runtime_config_linux_resources_rdma (get_val (tree, "rdma", yajl_t_object), ctx, err);
...
void
free_oci_runtime_config_linux_resources (oci_runtime_config_linux_resources *ptr)
{
    if (ptr == NULL)
        return;
    ...
    if (ptr->pids != NULL)
      {
        free_oci_runtime_config_linux_resources_pids (ptr->pids);
        ptr->pids = NULL;
      }
    if (ptr->block_io != NULL)
      {
        free_oci_runtime_config_linux_resources_block_io (ptr->block_io);
        ptr->block_io = NULL;
      }
    if (ptr->cpu != NULL)
      {
        free_oci_runtime_config_linux_resources_cpu (ptr->cpu);
        ptr->cpu = NULL;
      }
    if (ptr->hugepage_limits != NULL)      {
        ...
        for (i = 0; i < ptr->hugepage_limits_len; i++)
          ...
          if (ptr->hugepage_limits[i] != NULL)
            {
              free_oci_runtime_config_linux_resources_hugepage_limits_element (ptr->hugepage_limits[i]);
    ...
    if (ptr->memory != NULL)
      {
        free_oci_runtime_config_linux_resources_memory (ptr->memory);
        ptr->memory = NULL;
      }
    if (ptr->network != NULL)
      {
        free_oci_runtime_config_linux_resources_network (ptr->network);
        ptr->network = NULL;
      }
    if (ptr->rdma != NULL)
      {
        free_oci_runtime_config_linux_resources_rdma (ptr->rdma);
        ptr->rdma = NULL;
      }
    yajl_tree_free (ptr->_residual);
    ptr->_residual = NULL;
...
yajl_gen_status
gen_oci_runtime_config_linux_resources (yajl_gen g, const oci_runtime_config_linux_resources *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->devices != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_linux_device_cgroup (g, ptr->devices[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->pids != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_config_linux_resources_pids (g, ptr != NULL ? ptr->pids : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->block_io != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_config_linux_resources_block_io (g, ptr != NULL ? ptr->block_io : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->cpu != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_config_linux_resources_cpu (g, ptr != NULL ? ptr->cpu : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->hugepage_limits != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_config_linux_resources_hugepage_limits_element (g, ptr->hugepage_limits[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->memory != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_config_linux_resources_memory (g, ptr != NULL ? ptr->memory : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->network != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_config_linux_resources_network (g, ptr != NULL ? ptr->network : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->rdma != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_config_linux_resources_rdma (g, ptr != NULL ? ptr->rdma : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if (ptr != NULL && ptr->_residual != NULL)
...
define_cleaner_function (oci_runtime_config_linux_seccomp *, free_oci_runtime_config_linux_seccomp)
oci_runtime_config_linux_seccomp *
make_oci_runtime_config_linux_seccomp (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux_seccomp) oci_runtime_config_linux_seccomp *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->syscalls[i] = make_oci_runtime_defs_linux_syscall (val, ctx, err);
...
void
free_oci_runtime_config_linux_seccomp (oci_runtime_config_linux_seccomp *ptr)
{
    if (ptr == NULL)
        return;
    ...
    if (ptr->syscalls != NULL)      {
        ...
        for (i = 0; i < ptr->syscalls_len; i++)
          ...
          if (ptr->syscalls[i] != NULL)
            {
              free_oci_runtime_defs_linux_syscall (ptr->syscalls[i]);
              ptr->syscalls[i] = NULL;
            }
          }
        free (ptr->syscalls);
...
yajl_gen_status
gen_oci_runtime_config_linux_seccomp (yajl_gen g, const oci_runtime_config_linux_seccomp *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->syscalls != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_linux_syscall (g, ptr->syscalls[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
...
define_cleaner_function (oci_runtime_config_linux_intel_rdt *, free_oci_runtime_config_linux_intel_rdt)
oci_runtime_config_linux_intel_rdt *
make_oci_runtime_config_linux_intel_rdt (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux_intel_rdt) oci_runtime_config_linux_intel_rdt *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_runtime_config_linux_intel_rdt (oci_runtime_config_linux_intel_rdt *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->clos_id);
...
yajl_gen_status
gen_oci_runtime_config_linux_intel_rdt (yajl_gen g, const oci_runtime_config_linux_intel_rdt *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
define_cleaner_function (oci_runtime_config_linux_time_offsets *, free_oci_runtime_config_linux_time_offsets)
oci_runtime_config_linux_time_offsets *
make_oci_runtime_config_linux_time_offsets (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux_time_offsets) oci_runtime_config_linux_time_offsets *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
    ...
    if (ret == NULL)
      return NULL;
    ret->boottime = make_oci_runtime_defs_linux_time_offsets (get_val (tree, "boottime", yajl_t_object), ctx, err);
    if (ret->boottime == NULL && *err != 0)
      return NULL;
    ret->monotonic = make_oci_runtime_defs_linux_time_offsets (get_val (tree, "monotonic", yajl_t_object), ctx, err);
...
void
free_oci_runtime_config_linux_time_offsets (oci_runtime_config_linux_time_offsets *ptr)
{
    if (ptr == NULL)
        return;
    if (ptr->boottime != NULL)
      {
        free_oci_runtime_defs_linux_time_offsets (ptr->boottime);
        ptr->boottime = NULL;
      }
    if (ptr->monotonic != NULL)
      {
        free_oci_runtime_defs_linux_time_offsets (ptr->monotonic);
        ptr->monotonic = NULL;
      }
    yajl_tree_free (ptr->_residual);
    ptr->_residual = NULL;
...
yajl_gen_status
gen_oci_runtime_config_linux_time_offsets (yajl_gen g, const oci_runtime_config_linux_time_offsets *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->boottime != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_defs_linux_time_offsets (g, ptr != NULL ? ptr->boottime : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->monotonic != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_defs_linux_time_offsets (g, ptr != NULL ? ptr->monotonic : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if (ptr != NULL && ptr->_residual != NULL)
...
define_cleaner_function (oci_runtime_config_linux *, free_oci_runtime_config_linux)
oci_runtime_config_linux *
make_oci_runtime_config_linux (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_runtime_config_linux) oci_runtime_config_linux *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->devices[i] = make_oci_runtime_defs_linux_device (val, ctx, err);
                if (ret->devices[i] == NULL)
                  return NULL;
              }
          }
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->uid_mappings[i] = make_oci_runtime_defs_id_mapping (val, ctx, err);
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->gid_mappings[i] = make_oci_runtime_defs_id_mapping (val, ctx, err);
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->namespaces[i] = make_oci_runtime_defs_linux_namespace_reference (val, ctx, err);
    ...
    while (0);
    ret->resources = make_oci_runtime_config_linux_resources (get_val (tree, "resources", yajl_t_object), ctx, err);
    ...
    while (0);
    ret->seccomp = make_oci_runtime_config_linux_seccomp (get_val (tree, "seccomp", yajl_t_object), ctx, err);
    ...
    while (0);
    ret->intel_rdt = make_oci_runtime_config_linux_intel_rdt (get_val (tree, "intelRdt", yajl_t_object), ctx, err);
    if (ret->intel_rdt == NULL && *err != 0)
      return NULL;
    ret->personality = make_oci_runtime_defs_linux_personality (get_val (tree, "personality", yajl_t_object), ctx, err);
    if (ret->personality == NULL && *err != 0)
      return NULL;
    ret->time_offsets = make_oci_runtime_config_linux_time_offsets (get_val (tree, "timeOffsets", yajl_t_object), ctx, err);
...
void
free_oci_runtime_config_linux (oci_runtime_config_linux *ptr)
{
    if (ptr == NULL)
        return;
    if (ptr->devices != NULL)      {
        ...
        for (i = 0; i < ptr->devices_len; i++)
          ...
          if (ptr->devices[i] != NULL)
            {
              free_oci_runtime_defs_linux_device (ptr->devices[i]);
              ptr->devices[i] = NULL;
            }
          }
        free (ptr->devices);
    ...
    if (ptr->uid_mappings != NULL)      {
        ...
        for (i = 0; i < ptr->uid_mappings_len; i++)
          ...
          if (ptr->uid_mappings[i] != NULL)
            {
              free_oci_runtime_defs_id_mapping (ptr->uid_mappings[i]);
    ...
    if (ptr->gid_mappings != NULL)      {
        ...
        for (i = 0; i < ptr->gid_mappings_len; i++)
          ...
          if (ptr->gid_mappings[i] != NULL)
            {
              free_oci_runtime_defs_id_mapping (ptr->gid_mappings[i]);
    ...
    if (ptr->namespaces != NULL)      {
        ...
        for (i = 0; i < ptr->namespaces_len; i++)
          ...
          if (ptr->namespaces[i] != NULL)
            {
              free_oci_runtime_defs_linux_namespace_reference (ptr->namespaces[i]);
    ...
    if (ptr->resources != NULL)
      {
        free_oci_runtime_config_linux_resources (ptr->resources);
        ptr->resources = NULL;
      }
    ...
    if (ptr->seccomp != NULL)
      {
        free_oci_runtime_config_linux_seccomp (ptr->seccomp);
        ptr->seccomp = NULL;
      }
    ...
    if (ptr->intel_rdt != NULL)
      {
        free_oci_runtime_config_linux_intel_rdt (ptr->intel_rdt);
        ptr->intel_rdt = NULL;
      }
    if (ptr->personality != NULL)
      {
        free_oci_runtime_defs_linux_personality (ptr->personality);
        ptr->personality = NULL;
      }
    if (ptr->time_offsets != NULL)
      {
        free_oci_runtime_config_linux_time_offsets (ptr->time_offsets);
...
yajl_gen_status
gen_oci_runtime_config_linux (yajl_gen g, const oci_runtime_config_linux *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->devices != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_linux_device (g, ptr->devices[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->uid_mappings != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_id_mapping (g, ptr->uid_mappings[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->gid_mappings != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_id_mapping (g, ptr->gid_mappings[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->namespaces != NULL))
      {
        ...
        for (i = 0; i < len; i++)
          {
            stat = gen_oci_runtime_defs_linux_namespace_reference (g, ptr->namespaces[i], ctx, err);
            if (stat != yajl_gen_status_ok)
                GEN_SET_ERROR_AND_RETURN (stat, err);
          }
        stat = yajl_gen_array_close ((yajl_gen) g);
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->resources != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_config_linux_resources (g, ptr != NULL ? ptr->resources : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->seccomp != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_config_linux_seccomp (g, ptr != NULL ? ptr->seccomp : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->intel_rdt != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_config_linux_intel_rdt (g, ptr != NULL ? ptr->intel_rdt : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->personality != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_defs_linux_personality (g, ptr != NULL ? ptr->personality : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->time_offsets != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_runtime_config_linux_time_offsets (g, ptr != NULL ? ptr->time_offsets : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
    if (ptr != NULL && ptr->_residual != NULL)
