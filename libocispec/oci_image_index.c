...
define_cleaner_function (oci_image_index_manifests_platform *, free_oci_image_index_manifests_platform)
oci_image_index_manifests_platform *
make_oci_image_index_manifests_platform (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_image_index_manifests_platform) oci_image_index_manifests_platform *ret = NULL;
    *err = NULL;
...
void
free_oci_image_index_manifests_platform (oci_image_index_manifests_platform *ptr)
{
    if (ptr == NULL)
        return;
...
yajl_gen_status
gen_oci_image_index_manifests_platform (yajl_gen g, const oci_image_index_manifests_platform *ptr, const struct parser_context *ctx, parser_error *err)
{
...
define_cleaner_function (oci_image_index_manifests_element *, free_oci_image_index_manifests_element)
oci_image_index_manifests_element *
make_oci_image_index_manifests_element (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_image_index_manifests_element) oci_image_index_manifests_element *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
...
void
free_oci_image_index_manifests_element (oci_image_index_manifests_element *ptr)
{
    if (ptr == NULL)
        return;
    free (ptr->media_type);
...
yajl_gen_status
gen_oci_image_index_manifests_element (yajl_gen g, const oci_image_index_manifests_element *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
    ...
    if ((ctx->options & OPT_GEN_KEY_VALUE) || (ptr != NULL && ptr->platform != NULL))
      {
        ...
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
        stat = gen_oci_image_index_manifests_platform (g, ptr != NULL ? ptr->platform : NULL, ctx, err);
        if (stat != yajl_gen_status_ok)
            GEN_SET_ERROR_AND_RETURN (stat, err);
      }
...
define_cleaner_function (oci_image_index *, free_oci_image_index)
oci_image_index *
make_oci_image_index (yajl_val tree, const struct parser_context *ctx, parser_error *err)
{
    __auto_cleanup(free_oci_image_index) oci_image_index *ret = NULL;
    *err = NULL;
    (void) ctx;  /* Silence compiler warning.  */
    if (tree == NULL)
      return NULL;
        ...
        if (tmp != NULL && YAJL_GET_ARRAY (tmp) != NULL)
          {
            ...
            for (i = 0; i < len; i++)
              {
                yajl_val val = values[i];
                ret->manifests[i] = make_oci_image_index_manifests_element (val, ctx, err);
...
void
free_oci_image_index (oci_image_index *ptr)
{
    if (ptr == NULL)
        return;
...
yajl_gen_status
gen_oci_image_index (yajl_gen g, const oci_image_index *ptr, const struct parser_context *ctx, parser_error *err)
{
    yajl_gen_status stat = yajl_gen_status_ok;
    *err = NULL;
    (void) ptr;  /* Silence compiler warning.  */
...
oci_image_index *
oci_image_index_parse_file (const char *filename, const struct parser_context *ctx, parser_error *err)
{
oci_image_index *ptr = NULL;size_t filesize;
    ...
    if (content == NULL)
      {
        if (asprintf (err, "cannot read the file: %s", filename) < 0)
            *err = strdup ("error allocating memory");
        return NULL;
      }ptr = oci_image_index_parse_data (content, ctx, err);return ptr;
}
oci_image_index * 
oci_image_index_parse_file_stream (FILE *stream, const struct parser_context *ctx, parser_error *err)
{oci_image_index *ptr = NULL;
size_t filesize;
    __auto_free char *content = NULL;
...
define_cleaner_function (yajl_val, yajl_tree_free)
 ...
 { 
  oci_image_index *ptr = NULL;__auto_cleanup(yajl_tree_free) yajl_val tree = NULL;
    char errbuf[1024];
...
ptr = make_oci_image_index (tree, ctx, err);return ptr; 
}
...
define_cleaner_function (yajl_gen, cleanup_yajl_gen)
 ...
 char * 
oci_image_index_generate_json (const oci_image_index *ptr, const struct parser_context *ctx, parser_error *err){
...
if (yajl_gen_status_ok != gen_oci_image_index (g, ptr, ctx, err))  {
        if (*err == NULL)
