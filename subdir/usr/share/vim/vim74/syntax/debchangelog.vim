...
syn match debchangelogTarget	contained "\v %(frozen|unstable|%(testing|%(old)=stable)%(-proposed-updates|-security)=|experimental|squeeze-%(backports%(-sloppy)=|volatile)|wheezy-backports|%(devel|lucid|precise|quantal|raring|saucy|trusty)%(-%(security|proposed|updates|backports|commercial|partner))=)+"
